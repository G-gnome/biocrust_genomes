...
# Root the tree
rooted_tree <- root(tree, outgroup = "Sporobolomyces_roseus")

# Drop the specified tip
straintree <- drop.tip(rooted_tree, "Sporobolomyces_roseus")
...
ggsave("Rhodotorula_vb21_tree.png", p1, width = 10, height = 6)